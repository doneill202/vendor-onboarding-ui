...
const pages = {
  ...
  3: function contacts(){
    ...
    // Prefill once if no contacts yet (invite from server or preserved through cache merge)
    try{
    ...
    app.appendChild(el('div',{class:'card'},
      ...
      el('div',{class:'row',style:'margin-bottom:30px;'}, add), // Add button on its own row + spacing
      table
    ));
